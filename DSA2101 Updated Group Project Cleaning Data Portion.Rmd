...
We want to create a scatter plot to compare the proportion of games a country wins when they are the host of the world cup to when they are not the host. We need to find 2 variables to plot the scatterplot:
