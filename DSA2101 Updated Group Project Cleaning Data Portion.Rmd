...
final_dataset <- winning_data %>%
                 ...
                 mutate(continent = case_when(
                   winning_team %in% c("Argentina", "Brazil", "Costa Rica", "Uruguay", "United States",
                                       "Colombia", "Mexico", "Croatia", "Morocco", "Jamaica", "Paraguay",
                                       "Ecuador", "Senegal", "Peru", "Greece", "Ivory Coast", "Chile",
                                       "Honduras", "Bolivia", "Trinidad and Tobago") ~ "Americas",
                   winning_team %in% c("Austria", "Belgium", "England", "Italy", "Romania", "Scotland",
                                       "Spain", "West Germany", "Yugoslavia", "Czechoslovakia", "Germany",
                                       "Netherlands", "Norway", "Republic of Ireland", "Sweden", "Switzerland",
                                       "Denmark", "FR Yugoslavia", "France", "Serbia", "Poland", "Portugal",
                                       "Czech Republic", "Bosnia and Herzegovina", "Ukraine", "Slovenia",
                                       "Iceland") ~ "Europe",
                   winning_team %in% c("Cameroon", "Soviet Union", "Bulgaria", "Nigeria", "Russia",
                                       "Saudi Arabia", "Iran", "Japan", "South Africa", "South Korea",
                                       "Australia", "Turkey", "Ghana", "Tunisia", "Algeria", "Slovakia",
