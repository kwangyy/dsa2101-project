...
Compiling all the countries in a dataset to also include countries that are involved in the world cup, but do not score any points at all over the years. 
```{r}
